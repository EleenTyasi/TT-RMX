...
class InventoryPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.uberLabel = DirectLabel(parent=self, relief=None, text='', text_scale=0.06, text_fg=(1, 0.3, 0.3, 1), text_shadow=(0,0,0,1), text_font=ToontownGlobals.getSignFont(), pos=(0, 0, 0.52))
    ...
    def enter(self):
        ...
        if laffCap > 0:
            self.uberLabel['text'] = f"UBER [{laffCap} Laff]"
        else:
            self.uberLabel['text'] = ""
