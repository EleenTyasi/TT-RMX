...
def createHealerHank(air, zoneId, pos, h):
    ...
    dna = ToonDNA.ToonDNA()
    # All-grey Cat Toon (gray body color 25, neutral plain gray/white shirt, sleeves, shorts color 27)
    dna.newToonFromProperties('cll', 'ms', 'm', 'm', 25, 0, 25, 25, 1, 27, 1, 27, 1, 27)
    npc.setDNAString(dna.makeNetString())
    npc.setHp(15)
    npc.setMaxHp(15)
