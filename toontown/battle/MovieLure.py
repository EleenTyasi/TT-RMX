...
def __createSuitDamageTrack(battle, suit, hp, lure, trapProp):
    ...
    crit_type = lure.get('crit_type', 0)
    result = Sequence()
    ...
    if trapName == 'banana':
        ...
        damageTrack = Sequence(Wait(0.5), Func(suit.showHpText, -hp, openEnded=0, crit_type=crit_type), Func(suit.updateHealthBar, hp))
        ...
        damageTrack = Sequence(Wait(3.5), Func(suit.showHpText, -hp, openEnded=0, crit_type=crit_type), Func(suit.updateHealthBar, hp))
        ...
        damageTrack = Sequence(Wait(2.3), Func(suit.showHpText, -hp, openEnded=0, crit_type=crit_type), Func(suit.updateHealthBar, hp))
