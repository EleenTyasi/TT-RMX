...
QuestDialogDict = {160: {GREETING: '',
 ...
 170: {QUEST: 'Nice work, now you know the difference between the 4 types of Cogs.\x07 For now, you will want to go find Librarian Larry here in Toontown Central.'},
 171: {QUEST: 'Nice work, now you know the difference between the 4 types of Cogs.\x07 Perhaps you should go see Banker Bob, he might have some information for you.'},
 172: {QUEST: 'Nice work, now you know the difference between the 4 types of Cogs.\x07 Go see Professor Pete.'},
 150: {GREETING: '',
        QUEST: "Head over to the Toontown Library in the Playground and talk to Librarian Larry!",
        INCOMPLETE_PROGRESS: "Librarian Larry is waiting for you in the Toontown Library in the Playground.",
        COMPLETE: "A new toon? Well, we've done away with the old film style here!\x07You might notice the brand-spanking-new EXP bar near your Laff Meter!\x07You'll learn new gags in time, but for now, just keep wrecking cogs as you have been, newbie!",
        LEAVING: QuestsDefaultLeaving},
 175: {GREETING: '',
       ...
       LEAVING: QuestsDefaultLeaving},
 400: {GREETING: '',
       QUEST: 'Throw and Squirt are great, but you will need more gags to fight higher level Cogs.\x07When you team up with other Toons against the Cogs, you can combine attacks for even more damage.\x07Toon EXP lets you level up your Toon and choose new Gag Tracks at milestone levels (Levels 5, 10, 15, 20, and 25).\x07Defeat Cogs, clear Cog Buildings, and complete Field Offices to earn EXP!',
       INCOMPLETE_PROGRESS: 'Keep earning Toon EXP by defeating Cogs to level up!',
       INCOMPLETE_WRONG_NPC: 'Keep earning Toon EXP by defeating Cogs!',
       COMPLETE: "Great job! In Toontown Remix, gag tracks unlock as your Toon levels up.\x07Whenever you reach a milestone Level, a selection modal will appear so you can pick any locked Gag Track to unlock!\x07Keep defeating Cogs and earning EXP!",
       LEAVING: QuestsDefaultLeaving},
 ...
 4001: {GREETING: '',
        QUEST: 'Now you get to earn EXP and level up to unlock your next gag track.\x07Keep defeating Cogs and clearing Cog Buildings to reach your next milestone Level!',
        INCOMPLETE_PROGRESS: 'Keep gaining EXP to level up!',
        INCOMPLETE_WRONG_NPC: 'Keep gaining EXP to level up!',
        COMPLETE: 'A wise decision! As you level up your Toon, you can select new Gag Tracks directly!',
        LEAVING: QuestsDefaultLeaving},
 4002: {GREETING: '',
        QUEST: 'Now you get to earn EXP and level up to unlock your next gag track.\x07Keep defeating Cogs and clearing Cog Buildings to reach your next milestone Level!',
        INCOMPLETE_PROGRESS: 'Keep gaining EXP to level up!',
...
UberOneLaffDeathAckMessage = 'The cogs took your gags.\nI don\'t know what the heck you expected.\nYou have ONLY ONE HP.\nGit Good. LMAO.'
PlaygroundRamDeathAckMessage = 'You got hurt, and ran back to the playground!\n\nYou didn\'t lose any gags, but you can\'t leave the playground until you\'re no longer sad.'
UberOneLaffRamDeathAckMessage = 'You got hurt, and ran back to the playground.\n\nDude. You can\'t do that. You have 1 Laff.\n\nGit Gud.'
...
QuestScriptTutorialMickey_1 = 'Welcome to Toontown! Come over here to the counter!'
QuestScriptTutorialMickey_2 = 'Welcome, new Toon!'
QuestScriptTutorialMickey_3 = 'Tutorial Tom will tell you all about the Cogs.\x07Step right up!'
QuestScriptTutorialMickey_4 = 'Welcome to Toontown! Come over here to the counter using the arrow keys or WASD.'
QuestScriptTutorialMinnie_1 = 'Welcome to Toontown! Come over here to the counter!'
QuestScriptTutorialMinnie_2 = 'Welcome, new Toon!'
QuestScriptTutorialMinnie_3 = 'Tutorial Tom will tell you all about the Cogs.\x07Step right up!'
...
TipDict = {TIP_NONE: ('',),
 ...
 TIP_STREET: ('There are four types of Cogs: Lawbots, Cashbots, Sellbots, and Bossbots.',
              ...
              'Some ToonTasks give you bonus Toon XP for completing them.',
