...
* **Multi-Round Status Engine**:
  ...
  * **Wet**: Squirt attacks apply the Wet debuff for follow-up accuracy and damage synergies.
  * **Burn & Weaken**: Applied via special gags and high-level Cog abilities.
...
### 1. 64-bit Engine Runtime
The required 64-bit custom Panda3D runtime (with Astron, libotp, and libtoontown support) is **pre-bundled** directly in `dependencies/panda3d/`. No external installation is required!
...
---
*Disclaimer: TT-RMX is a personal non-commercial tinkering and single-player modding project. Toontown Online is property of The Walt Disney Company. Please do not sue the eleen.* 
